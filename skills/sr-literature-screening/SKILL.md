...
description: "SR-核心文献筛选：检索结果需要去重、初筛、全文复筛并留下可审计排除理由时。Use for this specific doctoral research work package after routing; do not use as a generic end-to-end research assistant."
metadata:
  sr-id: "SR-08"
  aspect: "文献调研与领域结构"
...
Use this leaf Skill when: 检索结果需要去重、初筛、全文复筛并留下可审计排除理由时
...
**AI role:** 去重、排序、初步标注和发现边界样本，不作最终排除。

**Human intervention:** 博士生复核核心文献与所有边界排除，确认标准未随结果漂移。
...
Use this template: PRISMA 台账：记录 ID / 阶段 / 决定 / 理由 / 复核人 / 日期
...
每条记录有唯一状态，核心文献由人核验，排除理由可追踪且标准一致。
